...
let snxJSConnector = {
  ...
  setContractSettings: function(contractSettings) {
    ...
    if (this.signer) {
      this.uniswapV1Contract = new ethers.Contract(
        uniswapV1.address,
        uniswapV1.abi,
        this.signer
      );
      this.uniswapV2Contract = new ethers.Contract(
        uniswapV2.address,
        uniswapV2.abi,
        this.signer
      );
      ...
      this.curvepoolContract = new ethers.Contract(
        curvepool.address,
        curvepool.abi,
        this.signer
      );
...
export const connectToMetamask = async (networkId, networkName) => {
  try {
